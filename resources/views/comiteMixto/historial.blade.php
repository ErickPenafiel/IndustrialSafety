            ...
            @foreach ($historialComites as $historialComite)
                <tr>
                    <td class="text-center">
                        {{ $historialComite->trabajador->nombre . ' ' . $historialComite->trabajador->apellido }}</td>
                    <td class="text-center">
                        {{ $historialComite->trabajador2->nombre . ' ' . $historialComite->trabajador2->apellido }}</td>
                    <td class="text-center">
                        {{ $historialComite->trabajador3->nombre . ' ' . $historialComite->trabajador3->apellido }}</td>
                    <td class="text-center">
                        {{ $historialComite->trabajador4->nombre . ' ' . $historialComite->trabajador4->apellido }}</td>
