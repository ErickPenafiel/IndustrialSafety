            ...
            @foreach ($comiteMixtos as $comiteMixto)
                <tr>
                    <td class="text-center">
                        @if ($comiteMixto->trabajador1 == null)
                            <p class="text-danger">No hay miembro</p>
                        @else
                            {{ $comiteMixto->trabajador1->nombre . ' ' . $comiteMixto->trabajador1->apellido }}
                        @endif
                    </td>
                    <td class="text-center">
                        @if ($comiteMixto->trabajador2 == null)
                            <p class="text-danger">No hay miembro</p>
                        @else
                            {{ $comiteMixto->trabajador2->nombre . ' ' . $comiteMixto->trabajador2->apellido }}
                        @endif
                    </td>
                    <td class="text-center">
                        @if ($comiteMixto->trabajador3 == null)
                            <p class="text-danger">No hay miembro</p>
                        @else
                            {{ $comiteMixto->trabajador3->nombre . ' ' . $comiteMixto->trabajador3->apellido }}
                        @endif
                    </td>
                    <td class="text-center">
                        @if ($comiteMixto->trabajador4 == null)
                            <p class="text-danger">No hay miembro</p>
                        @else
                            {{ $comiteMixto->trabajador4->nombre . ' ' . $comiteMixto->trabajador4->apellido }}
                        @endif
                    </td>
