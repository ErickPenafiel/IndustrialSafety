            ...
            <div class="row col-12 mt-2">
                ...
                <select name="estado" id="estado" class="form-control">
                    @if ($capacitacion->estado == 'Aun no realizado')
                        <option value="Aun no realizado" selected>Aun no realizado</option>
                        <option value="En proceso">En proceso</option>
                        <option value="Realizado">Realizado</option>
                    @endif
                    @if ($capacitacion->estado == 'En proceso')
                        <option value="Aun no realizado">Aun no realizado</option>
                        <option value="En proceso" selected>En proceso</option>
                        <option value="Realizado">Realizado</option>
                    @endif

                    @if ($capacitacion->estado == 'Realizado')
                        <option value="Aun no realizado">Aun no realizado</option>
                        <option value="En proceso">En proceso</option>
